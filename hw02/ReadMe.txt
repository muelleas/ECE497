...
This program takes tehe idea of the etch-a-sketch from the first homework and then adds buttons to act as control inputs. The buttons are plugged in to GP0. These buttons operate interrups that update the screen with the moved curser. The pause button acts as a clear button. The  buttons are still debounced like the last part.