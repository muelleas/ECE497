...
static unsigned int gpioLED = 98;       ///< hard coding the LED gpio for this example to GP1_4
static unsigned int gpioButton = 97;   ///< hard coding the button gpio for this example to GP1_3
...
// gpio_set_value(gpioLED, ledOn);          // Not required as set by line above (here for reference)
   ...
   result = request_irq(irqNumber,             // The interrupt number requested
                        ...
                        IRQF_TRIGGER_RISING | RQF_TRIGGER_FALLING, //intrrupt on edge 
