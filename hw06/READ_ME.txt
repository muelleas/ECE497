...
Display Images
This section of the homework was to display a image using fbi -noverbose -T 1 -a boris.png and then be able to rotate it. i have 4 sheel scripts that when run after on.sh will rotate the image when displayed. These are called turn0.sh, turn90.sh, turn 180.sh, and turn 270.sh.
